  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">{t("Machines die je voor dit project reserveert.")}</p>
      </CardHeader>
      <CardContent className="space-y-3">
        {reservations.map((item) => (
          ...
          >
            <div className="space-y-1">
              <Label htmlFor={`type-${item.id}`} className="text-xs">{t("Type machine")}</Label>
              <Input
                id={`type-${item.id}`}
                name="machine_type"
            ...
            <div className="space-y-1">
              <Label htmlFor={`qty-${item.id}`} className="text-xs">{t("Aantal")}</Label>
              <Input
                id={`qty-${item.id}`}
                name="quantity"
                type="number"
            ...
            <div className="space-y-1">
              <Label htmlFor={`acc-${item.id}`} className="text-xs">{t("Accessoires")}</Label>
              <Input
                id={`acc-${item.id}`}
                name="accessories"
            ...
            <div className="space-y-1">
              <Label htmlFor={`date-${item.id}`} className="text-xs">{t("Datum")}</Label>
              <Input
                id={`date-${item.id}`}
            ...
            <div className="space-y-1">
              <Label htmlFor={`duration-${item.id}`} className="text-xs">{t("Duur")}</Label>
              <Input
                id={`duration-${item.id}`}
                name="duration"
            ...
            <div className="space-y-1">
              <Label htmlFor={`num-${item.id}`} className="text-xs">{t("Machinenummer")}</Label>
              <Input
                id={`num-${item.id}`}
                name="machine_number"
        ...
        >
          <div className="space-y-1">
            <Label htmlFor="new-type" className="text-xs">{t("Type machine")}</Label>
            <Input id="new-type" name="machine_type" placeholder={t("bv. Manitou")} className="h-8 text-xs" required />
          </div>
          <div className="space-y-1">
            <Label htmlFor="new-qty" className="text-xs">{t("Aantal")}</Label>
            <Input id="new-qty" name="quantity" type="number" min={1} defaultValue={1} className="h-8 text-xs" />
          </div>
          <div className="space-y-1">
            <Label htmlFor="new-acc" className="text-xs">{t("Accessoires")}</Label>
          ...
          <div className="space-y-1">
            <Label htmlFor="new-duration" className="text-xs">{t("Duur")}</Label>
            <Input id="new-duration" name="duration" className="h-8 text-xs" />
          </div>
          <div className="space-y-1">
            <Label htmlFor="new-num" className="text-xs">{t("Machinenummer")}</Label>
            <Input id="new-num" name="machine_number" className="h-8 text-xs" />
          </div>
          <div className="flex items-end">
            <Button type="submit" size="sm" className="h-8 text-xs">
              {t("Reservering toevoegen")}
            </Button>
          </div>
        </form>
      </CardContent>
